...
function Home() {
    ...
    const getTestimonial = async () => {
        const baseURL = `${API_URL}testimonial`;
    ...
    return (
        <div>
            <header class="header-area">
                ...
                <div id="home" class="header-hero bg_cover" style={{ backgroundImage: "url(assets/images/header-bg.jpg)" }}>
                    <div class="container">
            ...
            <section id="testimonial" class="testimonial-area">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        {testimonial?.length > 0 ? testimonial.map((data, index) => (
                            <div class="col-lg-4 col-md-7 col-sm-9" key={index}>
                                <div class="single-pricing mt-40">
                                    <div class="pricing-header text-center">
                                        <img src={API_URL + data.photo} alt="Testimonial" height={100} width={100} />
                                        <span class="price">{data.name}</span>
                                        <p class="year">{data.post}</p>
                                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="contact-form">
                                <form id="contact-form" action="/#" method="get" data-toggle="validator">
                                    <div class="row">
                                        <div class="col-md-6">
